...
export const mockModules: Module[] = [
    ...
    },
    {
        ...
        description:
            'Video tutorial styling halaman web menggunakan CSS Flexbox.',
        isPublished: true,
    },
    {
        id: 'MOD-101-03',
    ...
    },
    {
        ...
        description:
            'Belajar membuat halaman web interaktif dengan JavaScript.',
        isPublished: true,
    },
    // Basis Data (CS-102)
    {
        ...
        description:
            'Dasar-dasar sistem basis data dan diagram hubungan entitas.',
        isPublished: true,
    },
    {
        id: 'MOD-102-02',
        ...
        description:
            'Langkah-langkah menormalisasi database untuk mengurangi redundansi.',
        isPublished: true,
    },
];
...
export const mockAssignments: Assignment[] = [
    ...
    },
    {
        ...
        description:
            'Buat aplikasi kalkulator berbasis web menggunakan HTML, CSS, dan JavaScript DOM manipulation. Kalkulator harus mendukung operasi dasar matematika (+, -, *, /) serta fungsi clear.',
    ...
    },
    {
        ...
        description:
            'Rancang ERD untuk sistem penjualan online (e-commerce). Tentukan entitas, atribut, primary key, foreign key, serta kardinalitas relasi antar entitas. Kumpulkan dalam format PDF.',
...
export const mockSubmissions: Submission[] = [
    {
        ...
        grade: 92,
        feedback:
            'Sangat bagus! Struktur HTML rapi, styling modern dan layout responsif di mobile. Tingkatkan lagi di bagian contrast rasio warnanya.',
...
export const mockAnnouncements: Announcement[] = [
    {
        ...
        content:
            'Diberitahukan kepada seluruh mahasiswa TI-3A bahwa untuk pertemuan minggu ke-5 (JavaScript Lanjutan) akan dilaksanakan secara daring penuh menggunakan Zoom. Link meeting dapat dilihat di halaman detail course.',
    ...
    },
    {
        ...
        content:
            "Bagi mahasiswa yang nilai tugas 1 di bawah 70 wajib mengikuti sesi asistensi tambahan bersama asisten laboratorium pada hari Jum'at pukul 13.00 di Lab RPL.",
...
export const mockDiscussions: Discussion[] = [
    {
        ...
        content:
            'Halo teman-teman dan Pak Budi, saya masih agak bingung kapan sebaiknya kita menggunakan flex-wrap pada Flexbox dibandingkan langsung memakai CSS Grid untuk layout grid responsif? Ada tips praktisnya?',
        ...
        replies: [
            ...
            },
            {
                ...
                content:
                    'Tambahan Ahmad, biasanya saya pakai Grid untuk layout layout besar (misal header, sidebar, main area), lalu di dalam main area kalau ada daftar kartu yang jumlahnya dinamis, saya pakai Flexbox wrap.',
