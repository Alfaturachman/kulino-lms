...
export function LandingHowItWorks() {
    return (
        <section id="how-it-works" className="py-24 bg-surface2/30 border-t border-border">
            <div className="mx-auto max-w-[1200px] px-6">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    ...
                    <p className="text-[16px] text-muted leading-relaxed">
                        Nikmati pengalaman perkuliahan online terstruktur dengan empat langkah sederhana berikut.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-4 gap-8 relative">
                    ...
                    {steps.map((step) => {
                        ...
                        return (
                            <div key={step.number} className="bg-surface rounded-2xl border border-border p-6 relative hover:shadow-md transition-shadow">
                                ...
                                <div className={`size-12 rounded-xl ${step.color} flex items-center justify-center mb-6`}>
                                    <Icon size={24} />
                                </div>
